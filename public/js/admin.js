...
(function( factory ) {
	...
	if ( true ) {
		// AMD
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(39)], __WEBPACK_AMD_DEFINE_RESULT__ = (function ( $ ) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_core_js_fn_promise__ = __webpack_require__(40);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sidebar_js__ = __webpack_require__(247);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__datatable__ = __webpack_require__(248);




var PENDING_USERS = '/admin/users/pendings';
var VERIFIED_USERS = '/admin/users/verified';

$(document).ready(function () {
    var oAdmin = {
        init: function init() {
            __WEBPACK_IMPORTED_MODULE_1__sidebar_js__["a" /* default */].init();
            __WEBPACK_IMPORTED_MODULE_2__datatable__["a" /* default */].init();
            this.main();
        },
        /**
         * Main Function
         ...
         */
        checkActionByUrl: function checkActionByUrl() {
            if (new RegExp(PENDING_USERS).test(window.location.href) === true) {
                __WEBPACK_IMPORTED_MODULE_2__datatable__["a" /* default */].showPendingRequests();
            } else if (new RegExp(VERIFIED_USERS).test(window.location.href)) {
                __WEBPACK_IMPORTED_MODULE_2__datatable__["a" /* default */].showVerifiedUsers();
            }
        }
...
/* harmony default export */ __webpack_exports__["a"] = (oSidebar);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_datatables_net__ = __webpack_require__(202);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_datatables_net_bs4__ = __webpack_require__(249);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_datatables_net_bs4___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_datatables_net_bs4__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_datatables_net_responsive__ = __webpack_require__(250);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_datatables_net_responsive___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_datatables_net_responsive__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_datatables_net_bs4_css_dataTables_bootstrap4_css__ = __webpack_require__(251);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_datatables_net_bs4_css_dataTables_bootstrap4_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_datatables_net_bs4_css_dataTables_bootstrap4_css__);
...
var oDataTable = {
     ...
     */
    cacheDom: function cacheDom() {
        this.oUsersTable = __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#usersTable');
    },
    /**
    ...
    acceptUser: function acceptUser() {
        ...
        var oElement = __WEBPACK_IMPORTED_MODULE_4_jquery___default()(this);
        var oParent = oDataTable.getParentElement(oElement);
        var oRowData = oDataTable.oInitializedTable.row(oParent).data();
        var iID = parseInt(oRowData.id);
     ...
     * @param sAction
     */
    getParentElement: function getParentElement(oElement) {
        var oParent = oElement.parents('tr');
        var iChildDetector = oElement.parents('tr.child').length;
        if (iChildDetector > 0) {
     ...
     */
    showPendingRequests: function showPendingRequests() {
        this.oInitializedTable = oDataTable.oUsersTable.DataTable({
            ...
            columns: [{ data: 'id', name: 'id' }, { data: 'username', name: 'username' }, { data: 'lastname', name: 'lastname' }, { data: 'firstname', name: 'firstname' }, { data: 'email', name: 'email' }, { data: 'created_at', name: 'created_at' }, {
                data: null,
                searchable: false,
                orderable: false,
     ...
     */
    showVerifiedUsers: function showVerifiedUsers() {
        this.oInitializedTable = oDataTable.oUsersTable.DataTable({
            responsive: true,
            pageLength: 10,
            lengthChange: false,
            ...
            columns: [{ data: 'id', name: 'id' }, { data: 'username', name: 'username' }, { data: 'lastname', name: 'lastname' }, { data: 'firstname', name: 'firstname' }, { data: 'email', name: 'email' }, { data: 'user_role', name: 'user_role' }, {
                data: null,
                searchable: false,
                orderable: false,
     ...
     * @returns {*}
     */
    requestsForPending: function requestsForPending(iID, sAction) {
        return axios({
            method: 'POST',
...
/* harmony default export */ __webpack_exports__["a"] = (oDataTable);
...
(function( factory ){
	if ( true ) {
		// AMD
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(39), __webpack_require__(202)], __WEBPACK_AMD_DEFINE_RESULT__ = (function ( $ ) {
			return factory( $, window, document );
		}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	}
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js!./dataTables.bootstrap4.css", function() {
			var newContent = require("!!../../css-loader/index.js!./dataTables.bootstrap4.css");
